    ...
    return (
        <div className='px-4 lg:px-24 my-20 flex flex-col md:flex-row justify between items-center gap-12'>
            ...
            <div className='md:w-1/2 space-y-6'>
                <h2 className='text-lg font-bold my-5 md:w-3/4 leading-snug'>Find Your Favorite <span
                ...
                <p className='mb-10 text-lg md:w-5/6'>Lorem ipsum dolor sit, amet consectetur adipisicing elit.
                    Labore fuga praesentium numquam sint! Saepe voluptatibus,
                    consectetur nisi facilis praesentium quos ad maxime iure impedit,
                    quae possimus illo fugiat ducimus ipsa?</p>
                {/* stats */}
